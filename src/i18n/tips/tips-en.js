export default {
  ...
  no_corp_manager:
    "Your company has not signed corporation CLA or added any manager. You can't sign as employee",
  ...
  restricted_email_suffix:
    "Restricted email suffixes. Please use the company's exclusive email",
  ...
  send_find_pwd_email:
    'An email to reset your password has been sent to your mailbox. Please complete the password reset according to the prompt.',
  ...
  user_login_frozen:
    'The account has been frozen and will be retried in five minutes',
  ...
  invalid_id:
    'ID format error,ID can only contain upper and lower case letters, numbers, _ and .',
  ...
  sameEmailSuffix:
    'Email domain already exists, please do not add it repeatedly',
  no_link_or_unsigned: 'Invalid binding information',
  not_support_platform:
    'Privacy policy of this platform is not supported at present. Please store the privacy policy in the public warehouse of Gitee or Github',
  ...
  unknown_email:
    'Invalid email address. Enter an administrator or manager email address.',
